...
from vpython import * 
filename ='C:\\Users\\Alex\\solve-dynamic-\\Windows\\src\\dynamic_scenarios\\data_MURAXA(movimientorectilineouniformeaceleradoenelejex).txt'
...
a= vector(ax, 0, 0)  # Acceleration due to gravity (m/s^2)
